...
export default function About(){
    return(
            ...
            <section className="bg-sexta bg-gray-100 pt-10" id="About">
                ...
                <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl md:mt-20">
                    ...
                    <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
                        ...
                        <div aria-hidden="true" className="mt-10 lg:mt-0">
                            ...
                            <img src="/assets/About/foto-oliver.jpg" alt="Imagem sobre o Representante da empresa" className="mx-auto rounded-lg shadow-lg " />
                    ...
                    <div>
                        ...
                        <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
                            ...
                            <div className="mt-10 lg:mt-0 lg:col-start-1 lg:row-start-1 rounded-xl">
                                ...
                                <VideoComponent videoSrc="/assets/About/video2.mp4"/>
