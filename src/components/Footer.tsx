            ...
            <div className="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row ">
                ...
                <div className="flex flex-col justify-center pt-6 lg:pt-0">
                    ...
                    <div className="flex justify-center space-x-10">
                        ...
                        {/* <a rel="noopener noreferrer" href="#" title="Twitter" className="flex items-center justify-center w-12 h-12 rounded-full bg-terceira text-gray-50 hover:bg-primeira">
