                    ...
                    <div className="flex-1">
                        ...
                        <ul className="pt-2 pb-4 space-y-1 text-sm">
                            ...
                            <li className="rounded-sm">
                                <a rel="noopener noreferrer" href="#" className="flex items-center p-2 space-x-3 rounded-md" onClick={toggleMobileMenu}>
                            ...
                            <li className="rounded-sm">
                                ...
                                <a rel="noopener noreferrer" href="#Services" className="flex items-center p-2 space-x-3 rounded-md" onClick={toggleMobileMenu}>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-600">
                            ...
                            <li className="rounded-sm">
                                ...
                                <a rel="noopener noreferrer" href="#Contact" className="flex items-center p-2 space-x-3 rounded-md" onClick={toggleMobileMenu}>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-600">
                            ...
                            <li className="rounded-sm">
                                ...
                                <a rel="noopener noreferrer" href="#Quote" className="flex items-center p-2 space-x-3 rounded-md" onClick={toggleMobileMenu}>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-600">
                            ...
                            <li className="rounded-sm dark:bg-gray-100 dark:text-gray-900">
                                <a rel="noopener noreferrer" href="#FormFeedback" className="flex items-center p-2 space-x-3 rounded-md" onClick={toggleMobileMenu}>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-600">
                            ...
                            <li className="rounded-sm">
                                ...
                                <a rel="noopener noreferrer" href="#SocialMedia" className="flex items-center p-2 space-x-3 rounded-md" onClick={toggleMobileMenu}>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-600">
