...
import imagem from '../../../public/assets/SocialMedia/logo-empresa-tratado.png'
        ...
        <section className="bg-terceira">
            ...
            <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
                ...
                <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
                    ...
                    <h1 className="text-5xl font-bold leading-none sm:text-6xl text-white">Redes Sociais
                    
                    </h1>

                    <p className="mt-6 mb-8 text-lg sm:mb-12 text-white">Falar sobre os serviços que foram executados e que podem aprender ou pesquisar melhor acessando as redes.
                    </p>
