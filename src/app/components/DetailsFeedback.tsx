        ...
        <section className="p-6 bg-gray-200">
            ...
            <div className="container mx-auto mt-20">
                ...
                <div className="grid gap-6 my-16 lg:grid-cols-3">
                    ...
                    <div className="flex flex-col md:p-8 space-y-4 rounded-md dark:bg-gray-50">
            ...
            <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-center font-manrope mb-20 md:mb-0">
                            ...
                            <a rel="noopener noreferrer" href="#FormFeedback" className="px-8 py-3 text-lg font-semibold rounded bg-white hover:bg-terceira hover:text-white">Rate Now</a>

                            <a rel="noopener noreferrer" href="https://g.co/kgs/5WL22RM" target="_blank" className="px-8 py-3 text-lg font-semibold border rounded text-white bg-primeira hover:bg-white hover:text-black">Use Google</a>
            </div>
