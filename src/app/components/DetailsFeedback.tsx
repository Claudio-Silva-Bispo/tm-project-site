    ...
    return(
        ...
        <section className="p-6 bg-gray-200">
            ...
            <div className="container mx-auto mt-20">
                ...
                <span className="block mb-2 text-xs font-medium tracking-widest text-center uppercase text-terceira">How it works</span>
                ...
                <div className="grid gap-6 my-16 lg:grid-cols-3">
                    ...
                    <div className="flex flex-col p-8 space-y-4 rounded-md dark:bg-gray-50">
                        <div className="flex items-center justify-center flex-shrink-0 w-12 h-12 text-xl font-bold rounded-full bg-terceira text-gray-50">1</div>
                    ...
                    <div className="flex flex-col p-8 space-y-4 rounded-md dark:bg-gray-50">
                        <div className="flex items-center justify-center flex-shrink-0 w-12 h-12 text-xl font-bold rounded-full bg-terceira text-gray-50">2</div>
                        <p className="text-2xl font-semibold">
                    ...
                    <div className="flex flex-col p-8 space-y-4 rounded-md dark:bg-gray-50">
                        <div className="flex items-center justify-center flex-shrink-0 w-12 h-12 text-xl font-bold rounded-full bg-terceira text-gray-50">3</div>
                        <p className="text-2xl font-semibold">
